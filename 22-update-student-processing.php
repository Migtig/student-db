...
if(isset($_POST["firstname"]) == true) {
    if(trim($_POST["firstname"]) === "") {
        $formValid = false;
        array_push($errorMessages, "The first name cannot be blank.");
    }
    else {
...
if(isset($_POST["lastname"])) {
    if(trim($_POST["lastname"]) === "") {
        $formValid = false;
        array_push($errorMessages, "The last name cannot be blank.");
    }
    else {
...
if(!$formValid) {
    ...
    $updateQuery = "UPDATE students SET id='$stuNum', firstname='$fname', lastname='$lname' WHERE id='$heldId';";
    $updateResult = $db->query($updateQuery);



    if($updateResult) {
        $_SESSION["successMsg"] = "The student information was successfully updated.";
    }
    else {
        $_SESSION["errorMsg"] = "The student's information was not successfully updated.";
    }
}
